...
{friend_desc_table}"""
    ...
    score_table = table(
        ...
        [
            ...
            [
                val("pace"),
                "routine 유사도 75% + step1.q01 × step1.q02 관계 역할 25%",
                "20%",
            ],
    ...
    pace_role_suffix = (
        " 박종하님은 관계에서 방향을 잡는 역할을 맡고, 이해선님은 주변 사람을 살피고 챙기는 "
        "역할을 맡아 함께할 때 역할이 자연스럽게 나뉘어요."
    )
    pace_case_table = table(
        ["두 사람 routine 구간", "점수 차이", "실제 출력 예시 · 박종하/이해선"],
        [
            [
                "둘 다 탐험 (0~49)",
                "15 이하",
                "박종하님과 이해선님은 모두 새로운 제안과 즉흥적인 변화를 즐기는 편이에요."
                + pace_role_suffix,
            ],
            [
                "둘 다 탐험 (0~49)",
                "15 초과",
                "박종하님과 이해선님은 모두 새로운 변화를 즐겨요. 다만 박종하님은 재미가 보이면 "
                "바로 움직이고, 이해선님은 대략적인 흐름이 보일 때 더 편하게 함께해요."
                + pace_role_suffix,
            ],
            [
                "둘 다 루틴 (50~100)",
                "15 이하",
                "박종하님과 이해선님은 모두 약속을 미리 정하고 익숙한 흐름대로 움직일 때 편해요."
                + pace_role_suffix,
            ],
            [
                "둘 다 루틴 (50~100)",
                "15 초과",
                "박종하님과 이해선님은 모두 계획이 있을 때 편해요. 다만 박종하님은 정해진 순서를 "
                "더 중요하게 여기고, 이해선님은 계획 안에서도 약간의 변화를 받아들이는 편이에요."
                + pace_role_suffix,
            ],
            [
                "탐험 × 루틴",
                ...
                "있어요. 박종하님은 익숙한 흐름이 조금 더 편하고, 이해선님은 새로운 변화를 조금 "
                "더 즐기는 편이에요."
                + pace_role_suffix,
            ],
            [
                "탐험 × 루틴",
                "15 초과",
                "박종하님은 계획과 익숙한 흐름이 있을 때 편하고, 이해선님은 새로운 제안과 "
                "즉흥적인 변화가 있을 때 힘이 나요."
                + pace_role_suffix,
            ],
        ],
...
<span class="val">총점 = 거리 .25 + 갈등 .25 + 챙김 .20 + 함께 움직임 .20 + MBTI .10</span>.
...
<div class="two-col">
  ...
  <div><h4>04 함께 움직임 · routine × 관계 역할</h4>
  <p class="lead">routine 유사도 75%와 <span class="src">step1.q01 × step1.q02</span>에서 만든
  관계 역할 25%를 합산해요. 아래 15점 기준은 최종 점수 구간이 아니라 routine 상세 문장을
  고르는 기준이에요.</p>{pace_case_table}</div>
</div>
<div class="two-col">
