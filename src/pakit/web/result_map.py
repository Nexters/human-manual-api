...
Q_TITLE = {
    ...
    "step1.q11": "집에만 있으려다 결국 나온 이유는?",
    "step1.q12": "기분 안 좋을 때 반가운 메시지는?",
...
CHOICE = {
    ...
    "step1.q11": {
        "curiosity": "흥미로운 팝업을 봤다",
        "needed_by_someone": "너밖에 못 도와준다며 불러냈다",
        "clear_goal": "목표까지 딱 한 번 남았다",
        "responsibility": "친구 이사를 도와주기로 했다",
        "last_chance": "오늘 문 닫는 전시를 알았다",
        "fun": "친구들이 벌써 모여 난리 났다",
    },
    "step1.q12": {
        "listen_to_me": "천천히 들어줄게",
        "take_me_out": "일단 나와, 맛있는 거 먹자",
        "give_me_space": "혼자 정리되면 연락해",
...
설명 문구는 축을 보조로 써요. <b>step1.q09·q10(친구 선호)은 카드 계산에 안 써요.</b></p>
