...
{friend_desc_table}"""
    ...
    score_table = table(
        ...
        [
            ...
            [
                val("pace"),
                "routine 유사도 60% + 관계 역할 20% + 동원력 20%",
                "20%",
            ],
    ...
    pace_role_suffix = (
        " 박종하님은 관계에서 방향을 잡는 역할을 맡고, 끝낼 목표가 보여야 잘 움직여요. "
        "이해선님은 관계에서 주변 사람을 살피고 챙기는 역할을 맡고, 재밌는 일이 생겨야 힘이 나요."
    )
...
<div class="two-col">
  ...
  <div><h4>04 함께 움직임 · routine</h4>{pace_case_table}</div>
</div>
<div class="two-col">
