...
RESULT_CONTENT_VERSION = "2026-08-21.5"
...
SUPPORT_PREFERENCE_COPY: dict[tuple[str, str], str] = {
    ...
    ("take_me_out", "NF"): "내가 기분이 가라앉아 있으면, 답답한 게 풀리게 바람 쐬러 데려가주세요",
    (
        "take_me_out",
        "SF",
    ...
    ("solve_together", "NT"): "내가 혼자 끙끙대고 있으면, 뭐가 막힌 건지부터 같이 짚어주세요",
    ("solve_together", "ST"): "내가 혼자 끙끙대고 있으면, 지금 당장 할 일부터 같이 처리해주세요",
    ("solve_together", "NF"): "내가 혼자 끙끙대고 있으면, 왜 이렇게까지 힘든지부터 같이 봐주세요",
    ("solve_together", "SF"): "내가 혼자 끙끙대고 있으면, 당장 필요한 것부터 같이 챙겨주세요",
    (
        "make_me_laugh",
        "NT",
...
SOCIAL_ENERGY_WARNING_COPY: dict[tuple[str, str], str] = {
