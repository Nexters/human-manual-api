...
ASSESSMENT_SUBMISSION_RESPONSE_EXAMPLE: dict[str, Any] = {
    ...
    "unboxing_kit": {
        ...
        "description": (
            "처음부터 속마음을 전부 꺼내놓기보다는 상대의 반응을 살피며 조금씩 다가가요. "
            "하지만 한번 편안한 사이라고 느끼면 정을 깊게 붙이고 익숙한 일상을 함께 나누고 "
            "싶어 합니다. 서두르지 않고 믿음을 보여주면 오래도록 다정한 편이 되어주는 사람이에요."
        ),
        "packaging": {
            "type": "matryoshka_box",
            "name": "마트료시카 상자",
            "tags": ["탐색형", "밀착형"],
            "reason": (
                "가까워지고 싶은 마음은 깊지만, 상대의 반응을 살피며 한 겹씩 천천히 보여줘요. "
                "겉으로 보이는 것보다 안쪽에 더 많은 애정과 생각을 품고 있어, 열어볼수록 새로운 "
                "마음이 나오는 마트료시카 상자에 담겼습니다."
            ),
        },
        "opening_tool": {
            "type": "glove",
